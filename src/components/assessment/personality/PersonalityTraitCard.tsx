...
export function PersonalityTraitCard({ score, icon: Icon }: PersonalityTraitCardProps) {
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-xl font-semibold text-gray-900">{score.trait}</h3>
        ...
        <div className="mb-6">
          <div className="flex justify-between mb-2">
            <span className="text-sm font-medium text-gray-600">Trait Level</span>
        ...
        <div className="space-y-3">
          <h4 className="font-medium text-gray-900 flex items-center">
            <ChevronRight className="w-5 h-5 text-green-600 mr-1" />
            Career Implications
          </h4>
